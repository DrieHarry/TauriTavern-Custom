...
mod file_native_plugin_data_store;
mod file_native_plugin_repository;
...
pub use file_native_plugin_data_store::FileNativePluginDataStore;
pub use file_native_plugin_repository::FileNativePluginRepository;
